    ...
    <body class="text-white bg-[#231F20]">
        ...
        <section class="w-full min-h-screen">
            <div class="flex h-[20vh] relative z-[-2] items-center mb-10 slide-text">
                ...
                <h2 class="text-[36px] font-[400] text-center text-[#bc8c2d]">Concours International de Piano</h2>
            </div>
            <div class="w-9/12 min-h-[65vh] m-auto grid grid-cols-[49%,2%,49%] grid-rows-1 gap-x-10">
                <div class="col-span-3 w-3/5 mx-auto mb-20">
                    <h1 class="text-4xl text-center font-extrabold mb-5">Choisissez votre chemin</h1>
                </div>
                <a href="{{ route('marrakech.home') }}">
                    <div class="flex h-full py-10 items-center justify-around rounded-md border transition-transform duration-300 hover:-translate-y-4 hover:scale-[1.1] cursor-pointer">
                        <img class="w-1/3" src="{{ asset('Images/MarrakechLogo.png') }}" alt="MarrakechLogo">
                        <div class="w-2/5">
                ...
                <a href="{{ route('paris.home') }}">
                    <div class="flex h-full py-10 items-center justify-around rounded-md border transition-transform duration-300 hover:-translate-y-4 hover:scale-[1.1] cursor-pointer">
                        <img class="w-1/3" src="{{ asset('Images/ParisLogo.png') }}" alt="PrisLogo">
                        <div class="w-2/5">
