...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="text-white bg-black overflow-hidden">
        <aside class="fixed left-0 z-20 xs:w-3/12 xs:top-[38%] sm:w-[14%] lg:top-[20vh] xl:top-[18vh] xl:w-[10%]">
        ...
        <section class="w-full min-h-screen relative">
            ...
            <div class="m-auto grid grid-rows-1 absolute z-20 right-0 w-full xs:top-[10%] xs:grid-cols-2 lg:grid-cols-2 lg:gap-x-10 lg:top-[75%] xl:top-[70%]">
                <a href="{{ route('marrakech.home') }}" title="Concours International de Piano Marrakech">
                    <div class="flex flex-col h-full py-10 items-center justify-around cursor-pointer">
                        <div class="xs:w-2/4 sm:w-2/4 lg:w-3/4 xl:w-3/5">
            ...
            <div class="w-full xs:h-screen lg:h-[85vh]">
                <video class="w-[100vw] object-cover xs:h-[45vh] xs:mt-[23vh] lg:h-[85vh]" poster="{{ asset('Images/home-header-img.webp') }}" src="{{ asset('Videos/HomeHeaderVideo.mp4') }}" muted autoplay loop></video>
