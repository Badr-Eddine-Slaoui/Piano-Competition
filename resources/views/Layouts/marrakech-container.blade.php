...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="text-white bg-body">
        <header class="w-full xs:h-[10vh] sm:h-[12vh] md:h-[15vh] lg:h-[17vh] xl:h-[25vh] 2xl:h-[20vh]">
            <nav class="w-full fixed top-0 left-0 z-50 bg-black flex justify-between xs:h-[10vh] xs:p-[1vh] sm:h-[12vh] sm:p-[2vh] md:h-[15vh] lg:h-[17vh] xl:h-[25vh] 2xl:h-[20vh] xl:p-[3vh]">
                    ...
                    <ul class="w-full mx-5 text-white xs:text-[8px] sm:ml-auto sm:me-1 sm:flex sm:items-center sm:justify-between sm:font-semibold sm:gap-y-4 sm:text-[7px] md:text-[8px] lg:text-[10px] lg:gap-y-6 xl:text-[14px] xl:gap-y-8 2xl:text-[12px] 2xl:w-11/12 2xl:ms-0 2xl:me-auto">
                        ...
                        <li class="dropdown-container text-decoration-none relative xs:block xs:mb-5 sm:mb-0">
                          ...
                          <ul class="dropdown hidden bg-black ps-2 -ms-2 hover:grid grid-cols-1 grid-rows-1 xs:pt-5 sm:absolute sm:w-[200%] sm:py-3 sm:gap-y-5 md:gap-y-4 lg:gap-y-3 xl:gap-y-2 xl:py-2">
                            <li><a href="{{ route('marrakech.edition_2025') }}#programme" class="text-decoration-none xs:block xs:mb-5 sm:mb-2 hover:text-gold">Le programme du concours</a></li>
                            <li><a href="{{ route('marrakech.edition_2025') }}#classe-categories" class="text-decoration-none xs:block xs:mb-5 sm:mb-2 hover:text-gold">Classe - catégories</a></li>
                            <li><a href="{{ route('marrakech.reglement') }}" class="text-decoration-none xs:block xs:mb-5 sm:mb-2 hover:text-gold">Règlement</a></li>
                            <li><a href="{{ route('marrakech.edition_2025') }}#partitions" class="text-decoration-none xs:block xs:mb-5 sm:mb-2 hover:text-gold">Partitions</a></li>
                            {{-- <li><a href="{{ route('marrakech.edition_2025') }}#recompenses" class="text-decoration-none xs:block xs:mb-5 sm:mb-2 hover:text-gold">Récompenses</a></li> --}}
                          </ul>
                        </li>
                        <li class="dropdown-container text-decoration-none relative xs:block xs:mb-5 sm:mb-0">
                          ...
                          <ul class="dropdown hidden bg-black ps-2 -ms-2 hover:grid grid-cols-1 grid-rows-1 xs:pt-5 xs:w-full sm:absolute sm:w-[200%] sm:py-3 sm:gap-y-5 md:gap-y-4 lg:gap-y-3 xl:gap-y-2 xl:py-2">
                            <li><a href="{{ route('marrakech.home') }}#mot-de-la-presidente" class="text-decoration-none xs:block xs:mb-5 sm:mb-2 hover:text-gold">Mot de la présidente</a></li>
                            <li><a href="{{ route('marrakech.edition_2025') }}#composantes" class="text-decoration-none xs:block xs:mb-5 sm:mb-2 hover:text-gold">Organisation du concours</a></li>
                            <li><a href="{{ route('marrakech.presentation') }}#association-culturers-sans-frontieres" class="text-decoration-none xs:block xs:mb-5 sm:mb-2 hover:text-gold">Association Culturers sans frontières</a></li>
                            {{-- <li><a href="{{ route('marrakech.comite_honneur') }}" class="text-decoration-none xs:block xs:mb-5 sm:mb-2 hover:text-gold">Comité d’honneur</a></li> --}}
                            <li><a href="{{ route('marrakech.jury') }}" class="text-decoration-none xs:block xs:mb-5 sm:mb-2 hover:text-gold">Jury</a></li>
                          </ul>
                        </li>
                        <li class="dropdown-container text-decoration-none relative xs:block xs:mb-5 sm:mb-0">
                          ...
                          <i class="fa-solid fa-angle-down"></i>
                          <ul class="dropdown hidden bg-black ps-2 -ms-2 hover:grid grid-cols-1 grid-rows-1 xs:pt-5 xs:w-full sm:absolute sm:w-[200%] sm:py-3 sm:gap-y-5 md:gap-y-4 lg:gap-y-3 xl:gap-y-2 xl:py-2">
                            <li><a href="{{ route('marrakech.galerie') }}" class="text-decoration-none xs:block xs:mb-5 sm:mb-2 hover:text-gold">Galerie</a></li>
                            <li><a {{-- href="{{ route('marrakech.galerie') }}" --}} class="text-decoration-none xs:block xs:mb-5 sm:mb-2 hover:text-gold">Kit Presse</a></li>
                          </ul>
                        </li>
                        <li class="dropdown-container text-decoration-none relative xs:block xs:mb-5 sm:mb-0">
                          ...
                          <i class="fa-solid fa-angle-down"></i>
                          <ul class="dropdown hidden bg-black ps-2 -ms-2 hover:grid grid-cols-1 grid-rows-1 xs:pt-5 xs:w-full sm:absolute sm:w-[200%] sm:py-3 sm:gap-y-5 md:gap-y-4 lg:gap-y-3 xl:gap-y-2 xl:py-2">
                            <li><a href="{{ route('marrakech.partenaires') }}#partenaires-officiels" class="text-decoration-none xs:block xs:mb-5 sm:mb-2 hover:text-gold">Partenaires Officiels</a></li>
                            <li><a href="{{ route('marrakech.partenaires') }}#partenaires" class="text-decoration-none xs:block xs:mb-5 sm:mb-2 hover:text-gold">Partenaires</a></li>
                            <li><a href="{{ route('marrakech.partenaires') }}#partenaires-videos" class="text-decoration-none xs:block xs:mb-5 sm:mb-2 hover:text-gold">Videos Des Partenaires</a></li>
                          </ul>
                        </li>
        ...
        @yield('hero')
        <aside class="fixed left-0 top-[25vh] w-1/12 z-20 xs:hidden sm:block md:top-[30%] lg:top-[36%] xl:w-[8%] 2xl:w-[7.5%] 2xl:top-[33%]">
            <img loading="lazy" class="w-full" src="{{ asset('Images/LOGO PIANO SITE WEB/MC dorté 1.png')  }}" alt="SideImg">
        </aside>
        <div class="w-2/12 fixed xs:w-[12%] xs:z-50 xs:top-[2.5%] xs:left-1/2 sm:w-[12%] sm:top-[14.5%] sm:-left-2 md:w-[12%] md:top-[18.5%] md:-left-2 lg:w-1/12 lg:top-[20.5%] lg:left-0 xl:top-[25.5%] xl:-left-3 2xl:w-[6.5%] 2xl:top-[25%]">
          <a href="{{ route('marrakech.home') }}" title="Concours International de Piano Marrakech">
            <div class="flex flex-col h-full items-center justify-around cursor-pointer">
                <div class="xs:w-3/4 sm:w-2/3 lg:w-11/12 xl:w-4/6">
        ...
        {{-- @if($title !== "Contact")
            <section id="map" class="w-full my-5 xs:min-h-[20vh] sm:min-h-[30vh] sm:w-11/12 sm:ms-auto sm:me-8 md:grid md:grid-cols-2 md:grid-rows-1 md:mt-5 md:m-auto md:gap-x-10 md:min-h-[40vh] lg:min-h-[50vh] lg:ms-auto lg:me-14">
                <div class="flex relative z-[-2] items-center my-10 slide-text xs:h-[5vh] sm:h-[20vh] md:col-span-2">
                    ...
                    <h2 class="font-[400] font-Against text-center text-gold xs:text-[14px] sm:text-[24px] md:text-[28px] lg:text-[32px] xl:text-[36px]">Contactez-nous</h2>
                </div>
              ...
              <div class="mx-auto grid grid-rows-1 grid-cols-2 py-4 xs:w-11/12 sm:w-4/5">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-2 grid-rows-1 xs:gap-y-4 sm:gap-y-10">
                        ...
                        {{-- <p><a href="{{ route('marrakech.comite_honneur') }}" class="text-decoration-nonetext-white hover:text-gold xs:text-[10px] sm:text-[12px] md:text-[14px] lg:text-[16px] xl:text-[18px]">Comité d’honneur</a></p> --}}
                        ...
                        <p><a href="{{ route('marrakech.laureats') }}" class="text-decoration-nonetext-white hover:text-gold xs:text-[10px] sm:text-[12px] md:text-[14px] lg:text-[16px] xl:text-[18px]">Lauréats</a></p>
                        <p><a href="{{ route('marrakech.reglement') }}" class="text-decoration-nonetext-white hover:text-gold xs:text-[10px] sm:text-[12px] md:text-[14px] lg:text-[16px] xl:text-[18px]">Règlements</a></p>
                        <p><a href="{{ route('marrakech.reservation') }}" class="text-decoration-nonetext-white hover:text-gold xs:text-[10px] sm:text-[12px] md:text-[14px] lg:text-[16px] xl:text-[18px]">Réservation</a></p>
                        <p><a href="{{ route('marrakech.contact') }}" class="text-decoration-nonetext-white hover:text-gold xs:text-[10px] sm:text-[12px] md:text-[14px] lg:text-[16px] xl:text-[18px]">Contact</a></p>
                    </div>
                </div>
              </div>
            </div>
