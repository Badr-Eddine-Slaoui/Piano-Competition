    ...
    <body class="text-white bg-[#231F20]">
            ...
            <nav class="w-full h-[20vh] px-[3vh] py-[3vh] fixed top-0 left-0 z-10 bg-[#231F20] flex justify-between">
                ...
                <div class="w-3/6 grid grid-cols-1 grid-rows-2 mr-12">
                    ...
                    <ul class="w-full ml-auto flex items-center justify-between text-white font-semibold text-xl">
                        ...
                        <li><a href="{{ route('marrakech.galerie') }}" class="text-decoration-none border-b-4 border-[#bc8c2d]">Galerie</a></li>
        ...
        <section class="w-full min-h-screen my-5">
            <div class="flex h-[20vh] relative z-[-2] items-center my-10 slide-text">
                ...
                <h2 class="text-[36px] font-[400] text-center text-[#bc8c2d]">Galerie</h2>
            </div>
        ...
        <section class="w-full min-h-screen my-5">
            <div class="flex h-[20vh] relative z-[-2] items-center my-10 slide-text">
                <div class="h-[1px] w-1/5 bg-white me-5"></div>
                <h2 class="text-[36px] font-[400] text-center text-[#bc8c2d]">Photos</h2>
            </div>
            <div class="w-4/5 min-h-[80vh] m-auto">
                <div class="galerie-pics grid grid-cols-3 grid-rows-1 gap-10">
                    <div class="galerie-pic-container h-[50vh] relative hidden">
                        ...
                        <div class="pic-title absolute top-0 left-0 w-full h-full bg-black z-[1] flex justify-center items-center border border-white opacity-0 hover:opacity-[1]">
                            <p class="text-[18px] font-[400]">Pic Title</p>
                        </div>
                    </div>
                    <div class="galerie-pic-container h-[50vh] relative hidden">
                        <img loading="lazy" class="galerie-pic w-full h-full" src="{{ asset('Images/Edition.webp') }}" alt="Edition">
                ...
                <button id="show_more_pics" class="block mx-auto text-[18px] text-center py-3 px-5 bg-orange-600 rounded-xl my-20">Show More</button>
            </div>
        </section>
        <section class="w-full min-h-screen my-5">
            <div class="flex h-[20vh] relative z-[-2] items-center my-10 slide-text">
                <div class="h-[1px] w-1/5 bg-white me-5"></div>
                <h2 class="text-[36px] font-[400] text-center text-[#bc8c2d]">Videos</h2>
            </div>
            <div class="w-4/5 min-h-[80vh] m-auto">
                ...
                <button id="show_more_vids" class="block mx-auto text-[18px] text-center py-3 px-5 bg-orange-600 rounded-xl my-20">Show More</button>
            </div>
        </section>
