...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Les Laureats Marrakech</title>
    ...
    <body class="text-white bg-[#231F20] overflow-x-hidden">
            ...
            <nav class="w-full h-[20vh] px-[3vh] py-[3vh] fixed top-0 left-0 z-10 bg-[#231F20] flex justify-between">
                ...
                <div class="w-3/6 grid grid-cols-1 grid-rows-2 mr-12">
                    <ul class="w-full ml-auto flex items-center justify-between text-white font-semibold text-[18px]">
                        <li><a href="{{ route('marrakech.home') }}" class="text-decoration-none hover:border-b-4 border-[#bc8c2d]">Accueil</a></li>
                    ...
                    <ul class="w-full ml-auto flex items-center justify-between text-white font-semibold text-xl">
                        ...
                        <li><a href="{{ route('marrakech.laureats') }}" class="text-decoration-none border-b-4 border-[#bc8c2d]">Laureats</a></li>
        ...
        <section class="w-full min-h-screen my-5">
            <div class="flex h-[20vh] relative z-[-2] items-center my-10 slide-text">
                ...
                <h2 class="text-[36px] font-[400] text-center text-[#bc8c2d]">Les Laureats 2024</h2>
            </div>
            <div class="laureats w-4/6 min-h-screen mb-5 m-auto grid grid-cols-2 grid-rows-1 gap-x-10 gap-y-20">
                <div class="left">
                    <p class="text-[18px] font-bold text-[#bc8c2d] mb-5">Initiation:</p>
                    <p class="text-[18px] text-gray-400"><span class="text-white">1-</span> prix Mention très bien: El Bouanani Lina</p>
                    <p class="text-[18px] text-gray-400"><span class="text-white">2-</span> prix Mention très bien: Bouzoubaa Sara</p>
                    <p class="text-[18px] text-gray-400"><span class="text-white">3-</span> prix Mention très bien: Bennis Meryem</p>
                    <p class="text-[18px] text-gray-400"><span class="text-white">4-</span> prix Mention très bien: El Mouhtadi Jad</p>
                </div>
                <div class="right">
                    <p class="text-[18px] font-bold text-[#bc8c2d] mb-5">Débutant 1:</p>
                    <p class="text-[18px] text-gray-400"><span class="text-white">1-</span> prix Mention très bien: Saher Lylia</p>
                    <p class="text-[18px] text-gray-400"><span class="text-white">2-</span> prix Mention très bien: Tazi Amine</p>
                    <p class="text-[18px] text-gray-400"><span class="text-white">3-</span> prix Mention très bien : Boutaleb Ali</p>
                    <p class="text-[18px] text-gray-400"><span class="text-white">4-</span> prix Mention très bien : Mikou Leyla</p>
                </div>
                <div class="left">
                    <p class="text-[18px] font-bold text-[#bc8c2d] mb-5">Debutant2:</p>
                    <p class="text-[18px] text-gray-400"><span class="text-white">1-</span> prix Mention très bien : Mseffer Sophia</p>
                    <p class="text-[18px] text-gray-400"><span class="text-white">2-</span> prix Mention très bien:Zine Filali Chama</p>
                    <p class="text-[18px] text-gray-400"><span class="text-white">3-</span> prix Mention très bien: Hassoune Selman</p>
                    <p class="text-[18px] text-gray-400"><span class="text-white">4-</span> prix Mention très bien: Smires Lyna</p>
                </div>
                <div class="right">
                    <p class="text-[18px] font-bold text-[#bc8c2d] mb-5">Préparatoire 1:</p>
                    <p class="text-[18px] text-gray-400"><span class="text-white">1-</span> prix Mention très bien: Hilal Chadi</p>
                    <p class="text-[18px] text-gray-400"><span class="text-white">2-</span> prix Mention très bien: Bennis-Belozerskaya Sofia</p>
                    <p class="text-[18px] text-gray-400"><span class="text-white">3-</span> prix Mention très bien: Jellali Ziyad</p>
                    <p class="text-[18px] text-gray-400"><span class="text-white">4-</span> prix Mention très bien: Kadiri Ghita</p>
                </div>
                <div class="left">
                    <p class="text-[18px] font-bold text-[#bc8c2d] mb-5">Préparatoire 2 :</p>
                    <p class="text-[18px] text-gray-400"><span class="text-white">1-</span> prix Mention très bien: Tahiri Joutei Hassani Sophia</p>
                    <p class="text-[18px] text-gray-400"><span class="text-white">2-</span> prix Mention très bien: Dahab Kamil</p>
                    <p class="text-[18px] text-gray-400"><span class="text-white">3-</span> prix Mention très bien: Rhafiri Mayssane</p>
                    <p class="text-[18px] text-gray-400"><span class="text-white">4-</span> prix Mention très bien : Lahrichi Radia</p>
                </div>
                <div class="right">
                    <p class="text-[18px] font-bold text-[#bc8c2d] mb-5">Élémentaire 1:</p>
                    <p class="text-[18px] text-gray-400"><span class="text-white">1-</span> prix Mention très bien: Guessous Mehdi</p>
                    <p class="text-[18px] text-gray-400"><span class="text-white">2-</span> prix Mention très bien: El Rhazi Kenza</p>
                    <p class="text-[18px] text-gray-400"><span class="text-white">3-</span> prix Mention très bien: Moumile Kenza</p>
                    <p class="text-[18px] text-gray-400"><span class="text-white">4-</span> prix Mention très bien ex aequo: sanhadji Sofia</p>
                    <p class="text-[18px] text-gray-400"><span class="text-white">4-</span> prix Mention très bien ex aequo: Abouzaid Lyn</p>
                </div>
                <div class="left">
                    <p class="text-[18px] font-bold text-[#bc8c2d] mb-5">Élémentaire 2:</p>
                    <p class="text-[18px] text-gray-400"><span class="text-white">1-</span> prix Mention très bien: Hadni Layla</p>
                    <p class="text-[18px] text-gray-400"><span class="text-white">2-</span> prix Mention très bien: El Waradi Mohamed Sadik</p>
                    <p class="text-[18px] text-gray-400"><span class="text-white">3-</span> prix Mention bien: Lahlou Sofia</p>
                </div>
                <div class="right">
                    <p class="text-[18px] font-bold text-[#bc8c2d] mb-5">Moyen1:</p>
                    <p class="text-[18px] text-gray-400"><span class="text-white">1-</span> prix Mention très bien: Tazi Zineb</p>
                    <p class="text-[18px] text-gray-400"><span class="text-white">2-</span> prix Mention très bien: El Waradi Mohamed Yazid</p>
                    <p class="text-[18px] text-gray-400"><span class="text-white">3-</span> prix Mention très bien: Houmy Ines</p>
                </div>
                <div class="left">
                    <p class="text-[18px] font-bold text-[#bc8c2d] mb-5">Moyen2 :</p>
                    <p class="text-[18px] text-gray-400"><span class="text-white">1-</span> prix Mention très bien: Chami Dina</p>
                    <p class="text-[18px] text-gray-400"><span class="text-white">2-</span> prix Mention très bien: Nejjar Abdallah</p>
                    <p class="text-[18px] text-gray-400"><span class="text-white">3-</span> prix Mention très bien: Savoir Yassine</p>
                </div>
                <div class="right">
                    <p class="text-[18px] font-bold text-[#bc8c2d] mb-5">Supérieur 1:</p>
                    <p class="text-[18px] text-gray-400">Aucun prix</p>
                </div>
                <div class="left">
                    <p class="text-[18px] font-bold text-[#bc8c2d] mb-5">Supérieur 2:</p>
                    <p class="text-[18px] text-gray-400">Aucun prix</p>
                </div>
                <div class="right">
                    <p class="text-[18px] font-bold text-[#bc8c2d] mb-5">Excellence 1:</p>
                    <p class="text-[18px] text-gray-400"><span class="text-white">1-</span> prix Mention très bien: Antoine Tomasi</p>
                </div>
                <div class="left">
                    <p class="text-[18px] font-bold text-[#bc8c2d] mb-5">Virtuosité 2:</p>
                    <p class="text-[18px] text-gray-400">Aucun prix</p>
                </div>
                <div class="right">
                    <p class="text-[18px] font-bold text-[#bc8c2d] mb-5">Diplôme de Concert:</p>
                    <p class="text-[18px] text-gray-400">Mention très bien: Sebti Ralia</p>
                </div>
            </div>
        </section>
