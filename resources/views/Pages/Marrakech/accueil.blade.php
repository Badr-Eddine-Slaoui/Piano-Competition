...
@section('hero')
    <main class="w-full relative xs:h-[30vh] sm:h-[50vh] md:h-[60vh] lg:h-[80vh]">
        <img class="absolute xs:w-11/12 xs:left-[4%] xs:top-3 sm:w-4/6 sm:left-[17.5%] top-5" src="{{ asset('Images/logo partenaires officels.png') }}" alt="logo partenaires officels">
    ...
    <section id="mot-de-la-presidente" class="w-full my-5 xs:min-h-[20vh] sm:min-h-[30vh] md:min-h-[40vh] lg:min-h-[50vh]">
      <div class="grid grid-cols-1 grid-rows-1 xs:gap-y-10 xs:min-h-[20vh] sm:gap-y-16 sm:min-h-[30vh] sm:w-5/6 sm:ms-auto sm:me-8 md:min-h-[40vh] md:gap-y-32 lg:min-h-[65vh] lg:w-5/6 lg:ms-auto lg:me-14 lg:gap-y-40 xl:gap-y-52">
        <div class="flex relative z-[-2] items-center mt-10 slide-text xs:h-[5vh] xs:ms-5 sm:h-[20vh] sm:ms-0">
          <h2 class="font-[400] font-Against text-center text-gold xs:text-[14px] sm:text-[24px] md:text-[28px] lg:text-[32px] xl:text-[36px]">Mot de la présidente</h2>
        </div>
