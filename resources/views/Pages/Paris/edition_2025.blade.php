...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="text-white bg-[#231F20]">
            ...
            <nav class="w-full h-[20vh] px-[3vh] py-[3vh] fixed top-0 left-0 z-10 bg-[#231F20] flex justify-between">
                ...
                <div class="w-3/6 grid grid-cols-1 grid-rows-2 mr-12">
                    <ul class="w-full ml-auto flex items-center justify-between text-white font-semibold text-[18px]">
                        ...
                        <li><a href="{{ route('paris.edition_2025') }}" class="text-decoration-none border-b-4 border-[#bc8c2d]">Edition 2025</a></li>
        ...
        <section class="w-full min-h-screen my-5">
            ...
            <div class="w-5/6 min-h-[65vh] m-auto grid grid-cols-2 grid-rows-1">
                ...
                <div class="h-full ms-10">
                    <img src="{{ asset('Images/Posterparis.png') }}" alt="PosterMarrakech">
                </div>
            </div>
        </section>
        <section class="w-full min-h-screen my-5">
        ...
        <section class="my-20">
            <button class="block mx-auto text-[18px] text-center py-3 px-5 bg-orange-600 rounded-xl"><a class="text-decoration-none" href="{{ route('paris.inscription') }}">Inscrivez-vous</a></button>
        </section>
