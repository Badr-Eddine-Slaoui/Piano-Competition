    ...
    <body class="text-white bg-[#231F20]">
            ...
            <nav class="w-full h-[20vh] px-[3vh] py-[3vh] fixed top-0 left-0 z-10 bg-[#231F20] flex justify-between">
                ...
                <div class="w-3/6 grid grid-cols-1 grid-rows-2 mr-12">
                    <ul class="w-full ml-auto flex items-center justify-between text-white font-semibold text-[18px]">
                        <li><a href="{{ route('paris.home') }}" class="text-decoration-none border-b-4 border-[#bc8c2d]">Accueil</a></li>
        ...
        <section class="w-full min-h-screen my-5">
            ...
            <div class="w-5/6 min-h-[65vh] m-auto grid grid-cols-2 grid-rows-1">
                ...
                <div class="h-3/4">
                    <img src="{{ asset('Images/PosterParis.png') }}" alt="PosterParis">
                </div>
        ...
        <section class="w-full min-h-screen my-5">
            ...
            <div class="w-4/5 min-h-screen mb-5 m-auto grid grid-cols-2 grid-rows-1 gap-10">
                ...
                <div class="message h-[65vh] opacity-60 cursor-pointer hover:opacity-100 hover:-translate-y-3 hover:scale-105 transition-all duration-500">
                    <div class="info-container grid grid-rows-1 grid-cols-2 mb-5">
                        ...
                        <div class="infos">
                            ...
                            <p class="text-[18px] my-3">Mouvement Contraire - MAROC</p>
                        </div>
                    </div>
                    <p class="text-[18px] font-bold my-3">La musique nous réunira</p>
                    <q class="description text-justify text-gray-400 text-[14px]">Stimuler l’apprentissage autour d’un programme thématique, permettra à tous les pianistes d’exprimer leurs talents et leurs sensibilités ! De Bach à Schumann, de Liszt à Thomas Adès, les candidats nous feront vivre différentes émotions et leurs notes continueront de vibrer après leur passage. De Paris à Marrakech, la musique nous réunira et fera battre nos cœurs sur des notes et rythme . Êtes-vous prêt et prête pour le Concours International de Piano Mouvement Contraire édition 2024 ?
                ...
                <div class="message h-[65vh] opacity-60 cursor-pointer hover:opacity-100 hover:-translate-y-3 hover:scale-105 transition-all duration-500">
                    ...
                    <q class="description text-justify text-gray-400 text-[14px]">Chers amis,
